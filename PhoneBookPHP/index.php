...
<form method="post">
    ...
    <input type="radio" name="radiofind"  value="name" checked>Otsing nimi järgi
    <input type="radio" name="radiofind"  value="surname">Otsing perekonnanimi järgi
    <input type="radio" name="radiofind" value="num">Otsing telefoni numbri järgi
    <input type="radio" name="radiofind" value="email">Otsing emaili järgi
