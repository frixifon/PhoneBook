...
Также после авторизации, у пользователя появляется дополнительная кнопка в меню "Группы", в этой вкладке, пользователь может видеть все свои группы, а также контакты, которые в них находятся.
![PhoneBook](Screens/3.PNG)
При авторизации в роли админа, в меню появляется вкладка "Админ", при нажатии на которую, попадаешь в админ панель.
![PhoneBook](Screens/4.PNG)
![PhoneBook](Screens/5.PNG)
